<?php
/**
 * Template Name: Tasty Template
 * Description: A custom page template for showing tasty front-end layout
 */
get_header();
?>
    <div class="tasty-site-wrap">
      <div class="tasty-logo">
        <img src="<?php echo TASTY_PUBLIC_URL ?>assets/images/Logo-Badsanieren24.png" alt="" />
      </div>
      <div class="frame"></div>
      <div class="icons">
        <svg
